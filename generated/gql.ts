 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query GetMatchupBySlugs($input: GetMatchupBySlugsInput!) {\n  getMatchupBySlugs(input: $input) {\n    score1\n    score2\n  }\n}"): (typeof documents)["query GetMatchupBySlugs($input: GetMatchupBySlugsInput!) {\n  getMatchupBySlugs(input: $input) {\n    score1\n    score2\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query GetMatchupSpread($input: GetMatchupSpreadInput!) {\n  getMatchupSpread(input: $input) {\n    entrant1 {\n      id\n      name\n    }\n    entrant2 {\n      id\n      name\n    }\n    score1\n    score2\n  }\n}"): (typeof documents)["query GetMatchupSpread($input: GetMatchupSpreadInput!) {\n  getMatchupSpread(input: $input) {\n    entrant1 {\n      id\n      name\n    }\n    entrant2 {\n      id\n      name\n    }\n    score1\n    score2\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
